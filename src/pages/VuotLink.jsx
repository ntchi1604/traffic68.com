...
export default function VuotLink() {
    ...
    window.__debugDirect = { trafficType, isDirect, targetUrl };
    if (typeof window.__debugShown === 'undefined') { window.__debugShown = true; window.alert('isDirect=' + isDirect + ' type=' + trafficType); }
