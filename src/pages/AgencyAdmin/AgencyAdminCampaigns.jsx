...
const STATUS_COLORS = {
  running:   { cls: 'bg-green-100 text-green-700',  label: 'Đang chạy' },
  paused:    { cls: 'bg-yellow-100 text-yellow-700', label: 'Tạm dừng' },
  completed: { cls: 'bg-blue-100 text-blue-700',     label: 'Hoàn thành' },
  pending:   { cls: 'bg-gray-100 text-gray-600',     label: 'Chờ duyệt' },
};
...
export default function AgencyAdminCampaigns() {
  usePageTitle('Đại lý - Chiến dịch');
