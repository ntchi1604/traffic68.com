        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div>
                <p className="text-xs font-medium text-gray-600 mb-2">Nhanh chóng</p>
                <div className="grid grid-cols-3 gap-2">
                  {[100000, 200000, 500000, 1000000, 2000000, 5000000].map(q => (
                    <button
                      key={q}
                      onClick={() => setAmount(q.toString())}
                      className="py-2.5 px-3 rounded-lg bg-gray-50 hover:bg-blue-50 hover:border-blue-300 border border-transparent text-sm font-semibold text-gray-700 transition"
                    >
                      {fmt(q)} đ
                    </button>
                  ))}
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-4 font-bold text-white text-base rounded-2xl
          ...
          >
            {processing
              ...
              : (method === 'bep20' || method === 'trc20')
                ? <><UsdtIcon size={20} />Tạo đơn nạp Crypto<ArrowRight size={18} /></>
                : <><Wallet size={18} />Nạp vào Ví Traffic<ArrowRight size={18} /></>
            }
          </button>
        </div>
