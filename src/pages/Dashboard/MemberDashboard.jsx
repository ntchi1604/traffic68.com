...
export default function MemberDashboard() {
  ...
  const statCards = [
    ...
    { label: 'Nhiệm vụ đang xử lý', value: `${data?.pending || 0} nhiệm vụ`, subtext: `Còn ${fmt(data?.remainingViews || 0)} views`, Icon: Zap, iconBg: 'bg-orange-100', iconColor: 'text-orange-600', accentGradient: 'from-orange-400 to-orange-500' },
